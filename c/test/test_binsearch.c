...
typedef struct t_test_uint8_t
{
    ...
    uint64_t foundLLast;
} __attribute__((packed, aligned(128))) t_test_uint8_t;
...
typedef struct t_test_uint32_t
{
    ...
    uint64_t foundLFirst;
    uint64_t foundLLast;
} __attribute__((packed, aligned(128))) t_test_uint32_t;
...
typedef struct t_test_uint64_t
{
    ...
    uint64_t foundLFirst;
    uint64_t foundLLast;
} __attribute__((packed, aligned(128))) t_test_uint64_t;
...
int main()
{
    ...
    if (nrows != 251)
    {
        (void)fprintf_s(stderr, "Expecting 251 items, got instead: %" PRIu64 "\n", nrows);
        return 1;
    }
